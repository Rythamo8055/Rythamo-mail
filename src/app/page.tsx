    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto px-4 py-8 sm:py-12">
        ...
        <header className="text-center mb-10 relative">
          <a
            href="/dashboard"
            className="absolute right-0 top-0 text-gray-500 hover:text-green-400 transition-colors text-sm flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:rounded-lg focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
